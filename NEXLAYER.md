...
<!-- nexlayer:meta version=1 analyzed=2026-06-25T15:56:43Z repo=https://github.com/KatieHarris2397/full-stack_chatApp branch=main -->
...
A real-time chat application featuring instant messaging via Socket.io, user authentication with JWT, and a React-based frontend with TailwindCSS.
<!-- nexlayer:end -->
...
- frontend/ — React application and TailwindCSS styling
...
1. `npm install --prefix backend` — Install backend dependencies
2. `npm install --prefix frontend` — Install frontend dependencies
3. `docker-compose up -d` — Spin up MongoDB, Backend, and Frontend containers
...
| `backend` | `MONGO_URI` | `"mongodb://root:admin@mongo.pod:27017/chatdb?authSource=admin"` | plain |
  ...
  pods:
    ...
    - name: backend
      ...
      vars:
        ...
        PORT: "5001"
        HOSTNAME: "0.0.0.0"
        MONGO_URI: "mongodb://root:admin@mongo.pod:27017/chatdb?authSource=admin"
    - name: mongo
...
- The backend pod connects to the database via mongo.pod:27017
- The frontend pod communicates with the API via backend.pod:5001
- Frontend is served via Nginx to ensure production-grade static asset delivery
...
**Last deployed:** 2026-06-25T15:58:13Z  
...
| Date | Status | Notes |
|------|--------|-------|
| 2026-06-25T15:56:43Z | analyzed | initial repo analysis |
| 2026-06-25T15:58:13Z | success | deployed https://kitbear-studio-full-stack-chatapp.cloud.nexlayer.ai |
<!-- nexlayer:end -->
